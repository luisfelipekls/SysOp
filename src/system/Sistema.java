package system;// PUCRS - Escola Politécnica - Sistemas Operacionais
// Prof. Fernando Dotti
// Código fornecido como parte da solução do projeto de Sistemas Operacionais
//
// Estrutura deste código:
//    Todo código está dentro da classe *system.Sistema*
//    Dentro de system.Sistema, encontra-se acima a definição de HW:
//           Memory,  Word, 
...
public class Sistema {
	...
	// -------------------------------------------------------------------------------------------------------
	// -------------------------------------------------------------------------------------------------------
	// ------------------- SW - inicio - system.Sistema Operacional
	// -------------------------------------------------
